...
API_CONFIGS = [
    # API1配置（提取剧集）
    {
        'url': "http://192.168.5.11:4567/api/shares/",  #仅作示例，AT宿主机IP:外部端口/api/shares，必填项！！！！！！！！！！！！
        'key': "",                 #AT高级设置中获取，必填项！！！！！！！！！！！！
        'required_keywords': ["2025"],  # API1必须关键词
        'optional_keywords': ["季", "集", "EP","S0","国产剧"],   # API1可选关键词
        'monitor_days': 120,
        'try_join': True,
        'monitor_limit': 2000
    },
    # API2配置（提取电影）
    {
        'url': "http://192.168.5.11:4567/api/shares/",  # 同API1，必填项！！！！！！！！！！！！
        'key': "",                                     # 同API1，必填项！！！！！！！！！！！！
        'required_keywords': [],                       # API2必须关键词（空）
        'optional_keywords': ["原盘", "简繁", "简英","简中","双语","REMUX","主演","电影"],                       # API2可选关键词
        'monitor_days': 300,
        'try_join': True,
        'monitor_limit': 5000
    }
